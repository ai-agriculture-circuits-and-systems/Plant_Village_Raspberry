#!/usr/bin/env python3
"""
Convert raspberries dataset annotations to COCO JSON format.
...
def main():
    parser = argparse.ArgumentParser(description="Convert raspberries annotations to COCO JSON")
    parser.add_argument(
        "--root",
        type=Path,
